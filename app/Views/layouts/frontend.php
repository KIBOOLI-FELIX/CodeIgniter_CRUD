...
<html lang="en">
  <head>
    ...
    <!--alert css-->
    <link href="<?=base_url("assets/alertifyjs/css/alertify.css");?>" rel="stylesheet"/>
    <!-- <link href="https://cdn.datatables.net/1.13.4/css/jquery.dataTables.min.css" rel="stylesheet">
    <script src="https://cdn.datatables.net/1.13.4/js/jquery.dataTables.min.js"></script> -->
    <title>Code Igniter 4 Ajax CRUD</title>
  </head>
  <body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?=base_url("students/view");?>">Students</a>
        </li>
   ...
   <div class="app">
    ...
    <script src="<?=base_url("assets/jquery/jquery-3.6.0.js")?>"></script>
